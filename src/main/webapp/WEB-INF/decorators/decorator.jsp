...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/jquery/jquery-1.6.2.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/jquery/jquery-ui.js"></script>
...
<body>
	<header>
		<section class="container">
			<div id="logo" class="col-lg-4 col-sm-4 col-xs-6">
				Schedfox
			</div>
			<div class="mainmenu col-lg-8 col-sm-8 col-xs-6">
	...
	<section class="container">
		<div class="col-lg-12 col-sm-12 col-xs-12">
			<div class="reportClass">
				<h4 class="col-lg-3 col-sm-6 col-xs-12 p-0">Profit Analysis report</h4> 
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/d3/d3min.js"></script>
<script>
    var firstDate = "";
	var	 toDate = "";
	var lName;
	...
	function subTable(lName,bName,firstDate,toDate){
		...
		$('#locateHead').text('Employee details of Location-'+lName);
			d3.json("resources/js/sheet.json", function(error, jData){
				...
				/* Draw Table*/
				 var table = d3.select("#table2").append("table").attr("class","table table-bordered").attr("style","border-collapse:collapse;"),
				thead = table.append("thead"),
				tbody = table.append("tbody");
